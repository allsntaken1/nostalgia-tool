...
export const blackWhiteBosses: BossTrainer[] = [
  ...
  boss({
    ...
    levelCap: 16,
    team: [
      mon('Sandile', 16, ['Ground', 'Dark'], { moves: TODO_MOVES }),
      mon('Purrloin', 16, ['Dark'], { moves: TODO_MOVES }),
      mon('Patrat', 16, ['Normal'], { moves: TODO_MOVES }),
      mon('Patrat', 14, ['Normal'], { moves: TODO_MOVES }),
      mon('Patrat', 14, ['Normal'], { moves: TODO_MOVES }),
      mon('Sandile', 14, ['Ground', 'Dark'], { moves: TODO_MOVES }),
    ],
    notes: 'Required story event chasing the stolen Dragon Skull through Pinwheel Forest, fought alongside Burgh. Flattened from the four required Team Plasma Grunts in the Black/White trainer table: Sandile lv 16, Purrloin lv 16, Patrat lv 16, and Patrat/Patrat/Sandile lv 14. Verified per Bulbapedia (Pinwheel Forest page). TODO: confirm exact movesets for these specific grunts.',
  }),
  boss({
    id: 'bianca-3-bw',
    name: 'Bianca',
  ...
  boss({
    ...
    levelCap: 24,
    team: [
      mon('Watchog', 23, ['Normal'], { moves: TODO_MOVES }),
      mon('Scraggy', 23, ['Dark', 'Fighting'], { moves: TODO_MOVES }),
      mon('Liepard', 24, ['Dark'], { moves: TODO_MOVES }),
      mon('Trubbish', 24, ['Poison'], { moves: TODO_MOVES }),
      mon('Sandile', 23, ['Ground', 'Dark'], { moves: TODO_MOVES }),
      mon('Watchog', 23, ['Normal'], { moves: TODO_MOVES }),
    ],
    notes: 'Required Team Plasma story sequence inside the Cold Storage facility, fought alongside Cheren as Clay closes in. Flattened from the four container Team Plasma Grunts in the Black/White trainer table: Watchog/Scraggy lv 23, Liepard lv 24, Trubbish lv 24, and Sandile/Watchog lv 23. Verified per Bulbapedia (Cold Storage page). TODO: confirm exact movesets for these specific grunts.',
  }),
  boss({
    id: 'clay-bw',
    name: 'Clay',
  ...
  boss({
    ...
    levelCap: 50,
    team: [
      mon('Cofagrigus', 48, ['Ghost'], { ability: 'Mummy', moves: [mv('Psychic', 'Psychic', 90), mv('Will-O-Wisp', 'Fire'), mv('Shadow Ball', 'Ghost', 80), mv('Grass Knot', 'Grass')] }),
      mon('Jellicent', 48, ['Water', 'Ghost'], { ability: 'Cursed Body', moves: [mv('Shadow Ball', 'Ghost', 80), mv('Surf', 'Water', 95), mv('Energy Ball', 'Grass', 80), mv('Brine', 'Water', 65)] }),
      mon('Golurk', 48, ['Ground', 'Ghost'], { ability: 'Iron Fist', moves: [mv('Curse', 'Ghost'), mv('Brick Break', 'Fighting', 75), mv('Earthquake', 'Ground', 100), mv('Shadow Punch', 'Ghost', 60)] }),
      mon('Chandelure', 50, ['Ghost', 'Fire'], { ability: 'Flame Body', moves: [mv('Fire Blast', 'Fire', 120), mv('Psychic', 'Psychic', 90), mv('Shadow Ball', 'Ghost', 80), mv('Payback', 'Dark', 50)] }),
    ],
    notes: 'Elite Four (Ghost-type). Verified per Bulbapedia (Shauntal page). Note: Jellicent runs Brine in the first battle (not Recover).',
  }),
  boss({
    id: 'grimsley-bw',
    name: 'Grimsley',
  ...
  boss({
    ...
    levelCap: 50,
    team: [
      mon('Reuniclus', 48, ['Psychic'], { ability: 'Magic Guard', moves: [mv('Energy Ball', 'Grass', 80), mv('Thunder', 'Electric', 120), mv('Focus Blast', 'Fighting', 120), mv('Psychic', 'Psychic', 90)] }),
      mon('Musharna', 48, ['Psychic'], { ability: 'Synchronize', moves: [mv('Reflect', 'Psychic'), mv('Charge Beam', 'Electric', 50), mv('Shadow Ball', 'Ghost', 80), mv('Psychic', 'Psychic', 90)] }),
      mon('Sigilyph', 48, ['Psychic', 'Flying'], { ability: 'Wonder Skin', moves: [mv('Shadow Ball', 'Ghost', 80), mv('Ice Beam', 'Ice', 95), mv('Air Slash', 'Flying', 75), mv('Psychic', 'Psychic', 90)] }),
      mon('Gothitelle', 50, ['Psychic'], { ability: 'Frisk', moves: [mv('Calm Mind', 'Psychic'), mv('Thunderbolt', 'Electric', 95), mv('Shadow Ball', 'Ghost', 80), mv('Psychic', 'Psychic', 90)] }),
    ],
    notes: 'Elite Four (Psychic-type). Verified per Bulbapedia (Caitlin page).',
  }),
  boss({
    id: 'marshal-bw',
    name: 'Marshal',
    ...
    levelCap: 50,
    team: [
      mon('Throh', 48, ['Fighting'], { ability: 'Guts', moves: [mv('Stone Edge', 'Rock', 100), mv('Payback', 'Dark', 50), mv('Bulldoze', 'Ground', 60), mv('Storm Throw', 'Fighting', 60)] }),
      mon('Sawk', 48, ['Fighting'], { ability: 'Sturdy', moves: [mv('Stone Edge', 'Rock', 100), mv('Karate Chop', 'Fighting', 50), mv('Grass Knot', 'Grass'), mv('Retaliate', 'Normal', 70)] }),
      mon('Conkeldurr', 48, ['Fighting'], { ability: 'Sheer Force', moves: [mv('Stone Edge', 'Rock', 100), mv('Hammer Arm', 'Fighting', 100), mv('Retaliate', 'Normal', 70), mv('Grass Knot', 'Grass')] }),
      mon('Mienshao', 50, ['Fighting'], { ability: 'Inner Focus', moves: [mv('U-turn', 'Bug', 70), mv('Jump Kick', 'Fighting', 100), mv('Rock Slide', 'Rock', 75), mv('Retaliate', 'Normal', 70)] }),
    ],
    notes: 'Elite Four (Fighting-type). Verified per Bulbapedia (Marshal page).',
  }),
  boss({
    id: 'n-final-black-bw',
    name: 'N',
