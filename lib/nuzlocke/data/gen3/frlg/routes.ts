...
export const frlgLocations: FrlgLocation[] = [
  ...
  location('route-9', 'Route 9', 19.2, ['route']),
  location('route-10', 'Route 10', 19.4, ['route']),
  ...
  location('route-7', 'Route 7', 22.5, ['route']),
  ...
  location('route-23', 'Route 23', 43.5, ['route']),
  location('victory-road', 'Victory Road', 44, ['cave', 'dungeon']),
  location('indigo-plateau', 'Indigo Plateau', 45, ['boss-area']),
  location('power-plant', 'Power Plant', 45.5, ['dungeon', 'optional']),
  location('one-island', 'One Island', 46, ['town', 'optional', 'postgame']),
  location('kindle-road', 'Kindle Road', 47, ['route', 'optional', 'postgame']),
  location('mt-ember', 'Mt. Ember', 48, ['cave', 'dungeon', 'optional', 'postgame']),
  location('treasure-beach', 'Treasure Beach', 49, ['route', 'optional', 'postgame']),
  location('two-island', 'Two Island', 50, ['town', 'optional', 'postgame']),
  location('cape-brink', 'Cape Brink', 51, ['route', 'optional', 'postgame']),
  location('three-island', 'Three Island', 52, ['town', 'optional', 'postgame']),
  location('bond-bridge', 'Bond Bridge', 53, ['route', 'optional', 'postgame']),
  location('berry-forest', 'Berry Forest', 54, ['forest', 'optional', 'postgame']),
  location('cerulean-cave', 'Cerulean Cave', 55, ['cave', 'optional', 'postgame']),
];
