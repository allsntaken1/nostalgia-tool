...
export const xyLocations: XyLocation[] = [
  ...
  location('xy-route-18', 'Route 18', 43, ['route']),
  location('xy-terminus-cave', 'Terminus Cave', 44, ['cave', 'boss-area']),
  location('xy-couriway-town', 'Couriway Town', 45, ['town']),
  location('xy-route-19', 'Route 19', 46, ['route']),
  location('xy-snowbelle-city', 'Snowbelle City', 47, ['city', 'gym', 'boss-area']),
  location('xy-lysandre-labs', 'Lysandre Labs', 48, ['dungeon', 'boss-area']),
  location('xy-team-flare-secret-hq', 'Team Flare Secret HQ', 49, ['dungeon', 'boss-area']),
